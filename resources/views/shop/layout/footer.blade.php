                ...
                <div class="mt-4">
                    ...
                    <div class="d-inline-block d-md-block mb-4">
                        <form class="form-inline" method="POST" action="https://www.ebeebbuy.cc/subscribers">
                            <input type="hidden" name="_token" value="KJouRyNDcGqDccZbaW6oe0EUyQjUVXu4XNFb9YWJ">
            ...
            <div class="aiz-user-sidenav rounded overflow-auto c-scrollbar-light pb-5 pb-xl-0">
                <div class="p-4 text-xl-center mb-4 border-bottom bg-primary text-white position-relative">
                    <span class="avatar avatar-md mb-3">
                        <img src="https://www.ebeebbuy.cc/public/uploads/all/rZBm8c6i36TsiDrgz062JFK2aPbX6paG6wvPMogJ.jpg"
                            onerror="this.onerror=null;this.src='https://www.ebeebbuy.cc/public/assets/img/avatar-place.png';">
                    </span>
                ...
                <div class="sidemnenu mb-3">
                    <ul class="aiz-side-nav-list px-2" data-toggle="aiz-side-menu">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="https://www.ebeebbuy.cc/conversations" class="aiz-side-nav-link "
                                style="align-items: center">
                                <i class="las la-comment aiz-side-nav-icon"></i>
                                <span class="aiz-side-nav-text">Cuộc trò chuyện</span>
                                <span class="badge badge-danger badge-circle badge-sm badge-dot" id="conversations"
