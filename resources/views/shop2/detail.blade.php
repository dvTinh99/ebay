                    ...
                    <div class="text-left">
                        ...
                        <div class="row no-gutters mt-3">
                            ...
                            <div class="col-10">
                                ...
                                <a href="/return-policy" class="ml-2" target="_blank">Xem
                                    chính sách</a>
                            </div>
                        </div>
        ...
        <div class="row gutters-10">
                                ...
                                <li class="py-3 px-0 list-group-item border-light">
                                    <div class="row gutters-10 align-items-center">
                                        ...
                                        <div class="col-7 text-left">
                                            ...
                                            <div class="mt-2">
                                                <span class="fs-17 fw-600 text-primary">${{ $productSell->price }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </li>
            ...
            <div class="col-xl-9 order-0 order-xl-1">
                ...
                <div class="bg-white rounded shadow-sm mt-3">
                    ...
                    <p class="fs-14 fw-400 mb-0 ml-3 mt-2"><a href="/users/login">Đăng nhập</a>
                        or <a class="mr-1" href="/users/registration">Đăng ký</a>để gửi câu
