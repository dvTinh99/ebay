...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?= asset('/kho')?>/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?= asset('/kho')?>/index2.html"><b>Admin</b></a>
  </div>
  <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="<?= asset('/kho')?>/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
